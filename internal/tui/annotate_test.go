...
func TestModel_EnterInDiffPaneScrollsToShowAnnotationInputAtBottom(t *testing.T) {
	lines := []git.DiffLine{
		...
		{NewNum: 5, Content: "line5", ChangeType: git.ChangeContext},
	}
	m := testModel([]string{"a.go"}, map[string][]git.DiffLine{"a.go": lines})
	m.tree = testNewFileTree([]string{"a.go"})
	m.layout.focus = paneDiff
...
func TestModel_AnnotateEnterSaves(t *testing.T) {
	...
	assert.Equal(t, string(git.ChangeContext), anns[0].Type)
}
...
func TestModel_AnnotateHunkKeywordSetsEndLine(t *testing.T) {
	lines := []git.DiffLine{
		{OldNum: 1, NewNum: 1, Content: "ctx before", ChangeType: git.ChangeContext},
		{OldNum: 2, Content: "old line", ChangeType: git.ChangeRemove},
		{NewNum: 2, Content: "new line", ChangeType: git.ChangeAdd},
		{NewNum: 3, Content: "added line", ChangeType: git.ChangeAdd},
		{OldNum: 3, NewNum: 4, Content: "ctx after", ChangeType: git.ChangeContext},
	}
...
func TestModel_AnnotateReAnnotateKeywordChange(t *testing.T) {
	lines := []git.DiffLine{
		...
		{NewNum: 2, Content: "new line", ChangeType: git.ChangeAdd},
		{NewNum: 3, Content: "added line", ChangeType: git.ChangeAdd},
		{OldNum: 2, NewNum: 4, Content: "ctx after", ChangeType: git.ChangeContext},
	}
...
func TestModel_AnnotateSingleLineHunkWithKeyword(t *testing.T) {
	...
	lines := []git.DiffLine{
		{OldNum: 1, NewNum: 1, Content: "ctx before", ChangeType: git.ChangeContext},
		{NewNum: 2, Content: "single add", ChangeType: git.ChangeAdd},
		{OldNum: 2, NewNum: 3, Content: "ctx after", ChangeType: git.ChangeContext},
	}
...
func TestModel_AnnotateRemovedLineInMixedHunk(t *testing.T) {
	...
	lines := []git.DiffLine{
		{OldNum: 10, NewNum: 10, Content: "ctx before", ChangeType: git.ChangeContext},
		{OldNum: 11, Content: "removed 1", ChangeType: git.ChangeRemove},
		{OldNum: 12, Content: "removed 2", ChangeType: git.ChangeRemove},
		{NewNum: 11, Content: "added 1", ChangeType: git.ChangeAdd},
		{NewNum: 12, Content: "added 2", ChangeType: git.ChangeAdd},
		{OldNum: 13, NewNum: 13, Content: "ctx after", ChangeType: git.ChangeContext},
	}
	...
	assert.Equal(t, string(git.ChangeRemove), anns[0].Type)
}
...
func TestModel_AnnotateOnAddLine(t *testing.T) {
	lines := []git.DiffLine{
		{NewNum: 3, Content: "new line", ChangeType: git.ChangeAdd},
	}
	m := testModel([]string{"a.go"}, nil)
	m.layout.focus = paneDiff
	m.file.name = "a.go"
	...
	assert.Equal(t, string(git.ChangeAdd), anns[0].Type)
}

func TestModel_AnnotateOnRemoveLine(t *testing.T) {
	lines := []git.DiffLine{
		{OldNum: 7, Content: "removed line", ChangeType: git.ChangeRemove},
	}
	m := testModel([]string{"a.go"}, nil)
	m.layout.focus = paneDiff
	m.file.name = "a.go"
...
func TestModel_AnnotatePreFillsExisting(t *testing.T) {
	...
	m.file.lines = lines
	m.nav.diffCursor = 0
	m.store.Add(annot.Annotation{File: "a.go", Line: 1, Type: " ", Comment: "old comment"})
...
func TestModel_DeleteAnnotation(t *testing.T) {
	...
	m.file.lines = lines
	m.nav.diffCursor = 0
	m.nav.onAnnotationRow = true // cursor on the annotation sub-line
	m.store.Add(annot.Annotation{File: "a.go", Line: 1, Type: " ", Comment: "test comment"})
...
func TestModel_RenderDiffWithAnnotations(t *testing.T) {
	...
	m.file.lines = []git.DiffLine{
		...
		{NewNum: 2, Content: "func foo() {}", ChangeType: git.ChangeAdd},
	}
	m.store.Add(annot.Annotation{File: "a.go", Line: 2, Type: "+", Comment: "needs error handling"})
...
func TestModel_CustomAnnotationMarker(t *testing.T) {
	...
	m.layout.width = 120
	m.layout.height = 40
	m.layout.treeWidth = m.layout.width * m.session.treeWidthRatio / 10
	m.ready = true
	m.filesLoaded = true
...
func TestModel_EmptyAnnotationMarkerExplicit(t *testing.T) {
	...
	m.store.Add(annot.Annotation{File: "a.go", Line: 1, Type: " ", Comment: "bare note"})
	m.store.Add(annot.Annotation{File: "a.go", Line: 0, Type: "", Comment: "file note"})
...
func TestModel_AnnotationCountInStatusBar(t *testing.T) {
	...
	m.store.Add(annot.Annotation{File: "b.go", Line: 5, Type: " ", Comment: "other"})
...
func TestModel_FileLoadedDiscardsStaleResponse(t *testing.T) {
	...
	cLines := []git.DiffLine{{NewNum: 1, Content: "package c", ChangeType: git.ChangeContext}}
...
func TestModel_FileLoadedStaleErrorDiscarded(t *testing.T) {
	...
	m.file.loadSeq = 1
	aLines := []git.DiffLine{{NewNum: 1, Content: "package a", ChangeType: git.ChangeContext}}
...
func TestModel_SameFileDuplicateLoadDiscarded(t *testing.T) {
	...
	staleLines := []git.DiffLine{{NewNum: 1, Content: "stale data", ChangeType: git.ChangeContext}}
...
func TestModel_FilterRefreshedAfterAnnotationSave(t *testing.T) {
	...
	m := testModel(files, nil)
	m.tree = testNewFileTree(files)
	m.store.Add(annot.Annotation{File: "a.go", Line: 1, Type: "+", Comment: "initial annotation"})
	...
	m.file.name = "b.go"
	m.file.lines = []git.DiffLine{{NewNum: 5, Content: "line5", ChangeType: git.ChangeContext}}
	m.nav.diffCursor = 0
	m.startAnnotation()
...
func TestModel_FilterRefreshedAfterAnnotationDelete(t *testing.T) {
	...
	diffs := map[string][]git.DiffLine{
		"b.go": {{NewNum: 5, Content: "line5", ChangeType: git.ChangeContext}},
	}
	m := testModel(files, diffs)
	m.tree = testNewFileTree(files)
	m.store.Add(annot.Annotation{File: "a.go", Line: 1, Type: " ", Comment: "annotation on a"})
	m.store.Add(annot.Annotation{File: "b.go", Line: 5, Type: " ", Comment: "annotation on b"})
	...
	m.file.name = "a.go"
	m.file.lines = []git.DiffLine{{NewNum: 1, OldNum: 1, Content: "line1", ChangeType: git.ChangeContext}}
	m.nav.diffCursor = 0
...
func TestModel_FilterDisabledWhenLastAnnotationDeleted(t *testing.T) {
	...
	m := testModel(files, nil)
	m.tree = testNewFileTree(files)
	m.store.Add(annot.Annotation{File: "a.go", Line: 1, Type: " ", Comment: "only annotation"})
...
func TestModel_AnnotationsPersistAcrossFileSwitch(t *testing.T) {
	linesA := []git.DiffLine{{NewNum: 1, Content: "line1", ChangeType: git.ChangeContext}, {NewNum: 2, Content: "added", ChangeType: git.ChangeAdd}}
	linesB := []git.DiffLine{{NewNum: 1, Content: "b-line1", ChangeType: git.ChangeContext}}
	m := testModel([]string{"a.go", "b.go"}, map[string][]git.DiffLine{"a.go": linesA, "b.go": linesB})
	m.tree = testNewFileTree([]string{"a.go", "b.go"})
...
func TestModel_AnnotateRenderWithDividers(t *testing.T) {
	...
	m.store.Add(annot.Annotation{File: "a.go", Line: 2, Type: "+", Comment: "addition comment"})
	m.store.Add(annot.Annotation{File: "a.go", Line: 11, Type: "-", Comment: "removal comment"})
...
func TestModel_PgDownAccountsForAnnotations(t *testing.T) {
	...
	for i := range 10 {
		model.store.Add(annot.Annotation{File: "a.go", Line: i + 1, Type: string(git.ChangeAdd), Comment: "annotation"})
	}
	...
	assert.True(t, m2.nav.diffCursor > 0 || m2.nav.onAnnotationRow,
...
func TestModel_FileAnnotationInputWidthNarrowerThanLineLevel(t *testing.T) {
	// file-level annotation has a wider prefix (marker plus "file: "), so input should be narrower
	lines := []git.DiffLine{
		{NewNum: 1, Content: "line1", ChangeType: git.ChangeAdd},
	}
	m := testModel([]string{"a.go"}, nil)
...
func TestModel_AnnotationInputWidthUsesMarkerWidth(t *testing.T) {
	lines := []git.DiffLine{{NewNum: 1, Content: "line1", ChangeType: git.ChangeAdd}}
	tests := []struct {
		name          string
		marker        string
		wantLineWidth int
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			m.layout.treeWidth = 30
			m.layout.treeHidden = false
			m.session.annotPrefix = tt.marker + " "
			m.session.annotFilePrefix = tt.marker + " file: "
...
func TestModel_FileAnnotationPreFillsExisting(t *testing.T) {
	...
	m.tree = testNewFileTree([]string{"a.go"})
	m.file.name = "a.go"
	m.file.lines = []git.DiffLine{{NewNum: 1, Content: "x", ChangeType: git.ChangeContext}}
	m.store.Add(annot.Annotation{File: "a.go", Line: 0, Type: "", Comment: "existing file note"})
...
func TestModel_FileAnnotationRenderedAtTopOfDiff(t *testing.T) {
	...
	m.store.Add(annot.Annotation{File: "a.go", Line: 0, Type: "", Comment: "this is a file note"})
...
func TestModel_EnterOnFileAnnotationLineTriggersFileAnnotation(t *testing.T) {
	...
	m.layout.focus = paneDiff
	m.nav.diffCursor = -1 // on file annotation line
	m.store.Add(annot.Annotation{File: "a.go", Line: 0, Type: "", Comment: "existing note"})
...
func TestModel_EnterOnFileAnnotationLinePreFillsText(t *testing.T) {
	...
	m.layout.focus = paneDiff
	m.nav.diffCursor = -1 // on file annotation line
	m.store.Add(annot.Annotation{File: "a.go", Line: 0, Type: "", Comment: "pre-existing comment"})
...
func TestModel_DeleteFileAnnotationViaD(t *testing.T) {
	...
	m.file.name = "a.go"
	m.file.lines = lines
	m.store.Add(annot.Annotation{File: "a.go", Line: 0, Type: "", Comment: "file note to delete"})
	m.nav.diffCursor = -1 // on file annotation line
...
func TestModel_DeleteFileAnnotationCursorNotOnFileLine(t *testing.T) {
	...
	m.file.lines = lines
	m.store.Add(annot.Annotation{File: "a.go", Line: 0, Type: "", Comment: "file note"})
	m.store.Add(annot.Annotation{File: "a.go", Line: 1, Type: " ", Comment: "line note"})
	m.nav.diffCursor = 0         // on regular line
	m.nav.onAnnotationRow = true // on the annotation sub-line for line 1
...
func TestModel_DeleteFileAnnotationFilterShiftsSelection(t *testing.T) {
	...
	m.file.name = "a.go"
	m.file.lines = lines
	m.store.Add(annot.Annotation{File: "a.go", Line: 0, Type: "", Comment: "file note on a"})
	m.store.Add(annot.Annotation{File: "b.go", Line: 1, Type: " ", Comment: "line note on b"})
	m.nav.diffCursor = -1 // on file annotation line
...
func TestModel_CursorViewportYWithWrappedAnnotation(t *testing.T) {
	...
	t.Run("long file annotation wraps to multiple rows", func(t *testing.T) {
		...
		m.store.Add(annot.Annotation{File: "a.go", Line: 0, Type: "", Comment: longComment})
	...
	t.Run("long inline annotation wraps to multiple rows", func(t *testing.T) {
		...
		m.store.Add(annot.Annotation{File: "a.go", Line: 1, Type: " ", Comment: longComment})
	...
	t.Run("short annotation stays one row", func(t *testing.T) {
		m.store.Add(annot.Annotation{File: "a.go", Line: 0, Type: "", Comment: "short"})
		defer m.store.Delete("a.go", 0, "")
...
func TestModel_CursorViewportYFromOffsetsMatchesDirectCalculation(t *testing.T) {
	...
	lines := []git.DiffLine{
		{NewNum: 1, Content: longLine, ChangeType: git.ChangeContext},
		{OldNum: 2, Content: "removed", ChangeType: git.ChangeRemove},
		{NewNum: 2, Content: "replacement", ChangeType: git.ChangeAdd},
		{NewNum: 3, Content: "tail", ChangeType: git.ChangeContext},
	}
	m := testModel([]string{"a.go"}, map[string][]git.DiffLine{"a.go": lines})
	m.file.name = "a.go"
	m.file.lines = lines
	...
	m.store.Add(annot.Annotation{
		File: "a.go", Line: 0, Comment: strings.Repeat("file note ", 12),
	})
	m.store.Add(annot.Annotation{
		File: "a.go", Line: 1, Type: string(git.ChangeContext),
	...
	require.Greater(t, m.wrappedAnnotationLineCount(m.annotationKey(1, string(git.ChangeContext))), 1,
	...
	for cursor := -1; cursor < len(lines); cursor++ {
		for _, onAnnotation := range []bool{false, true} {
			...
			m.nav.onAnnotationRow = onAnnotation
			assert.Equal(t,
				m.cursorViewportYUsing(hunks, annotationSet),
				m.cursorViewportYFromOffsets(offsets),
				"cursor=%d onAnnotationRow=%v", cursor, onAnnotation,
			)
		}
	}
}
...
func TestModel_RenderWrappedAnnotation(t *testing.T) {
	...
	m.layout.width = 60
	m.layout.treeWidth = 20
	m.file.lines = []git.DiffLine{{NewNum: 1, Content: "line1", ChangeType: git.ChangeContext}}
	m.layout.focus = paneDiff
...
func TestModel_SingleFileAnnotationWorks(t *testing.T) {
	lines := []git.DiffLine{
		...
		{NewNum: 2, Content: "added line", ChangeType: git.ChangeAdd},
	}
...
func TestModel_WrappedAnnotationLineCount_MultiLine(t *testing.T) {
	...
	t.Run("single-line short comment is one row", func(t *testing.T) {
		m := newModel()
		m.store.Add(annot.Annotation{File: "a.go", Line: 1, Type: " ", Comment: "hi"})
		defer m.store.Delete("a.go", 1, " ")
	...
	t.Run("multi-line without wrap counts each logical line", func(t *testing.T) {
		m := newModel()
		m.store.Add(annot.Annotation{File: "a.go", Line: 1, Type: " ", Comment: "one\ntwo\nthree"})
		defer m.store.Delete("a.go", 1, " ")
	...
	t.Run("multi-line with inner-line wrap sums wrapped rows", func(t *testing.T) {
		...
		short := "brief"
		m.store.Add(annot.Annotation{File: "a.go", Line: 1, Type: " ", Comment: long + "\n" + short})
		defer m.store.Delete("a.go", 1, " ")
	...
	t.Run("file-level multi-line annotation", func(t *testing.T) {
		m := newModel()
		m.store.Add(annot.Annotation{File: "a.go", Line: 0, Type: "", Comment: "line1\nline2"})
		defer m.store.Delete("a.go", 0, "")
...
func TestModel_AnnotateCtrlEOpensEditor(t *testing.T) {
	...
	require.Len(t, fake.CommandCalls(), 1, "extcmd.Command should be called once")
...
func TestModel_AnnotateCtrlEOpensEditorFileLevel(t *testing.T) {
	...
	require.Len(t, fake.CommandCalls(), 1, "extcmd.Command should be called once on file-level path")
...
func TestModel_EditorFinishedSavesMultiLineContent(t *testing.T) {
	lines := []git.DiffLine{
		{NewNum: 1, Content: "line1", ChangeType: git.ChangeContext},
		{NewNum: 2, Content: "line2", ChangeType: git.ChangeContext},
		{NewNum: 3, Content: "added", ChangeType: git.ChangeAdd},
	}
	m := testModel([]string{"a.go"}, map[string][]git.DiffLine{"a.go": lines})
	m.tree = testNewFileTree([]string{"a.go"})
	m.layout.focus = paneDiff
...
func TestModel_EditorFinishedEmptyContentPreservesExistingAnnotation(t *testing.T) {
	...
	m.store.Add(annot.Annotation{File: "a.go", Line: 3, Type: "+", Comment: "old comment"})
...
func TestModel_EditorFinishedFileLevelEmptyContentPreservesExistingAnnotation(t *testing.T) {
	...
	m.store.Add(annot.Annotation{File: "a.go", Line: 0, Type: "", Comment: "original file note"})
...
func TestModel_ReAnnotateMultiLinePreFillsEditor(t *testing.T) {
	// the annotation editor is a text area, so a stored multi-line comment
	// pre-fills verbatim and stays editable in place.
	lines := []git.DiffLine{
		{NewNum: 1, Content: "added", ChangeType: git.ChangeAdd},
	}
	m := testModel([]string{"a.go"}, map[string][]git.DiffLine{"a.go": lines})
	...
	m.file.lines = lines
	m.nav.diffCursor = 0
	m.store.Add(annot.Annotation{File: "a.go", Line: 1, Type: "+", Comment: "first line\nsecond line\nthird"})

	m.startAnnotation()
	assert.Equal(t, "first line\nsecond line\nthird", m.annot.input.Value(), "multi-line content pre-fills verbatim")
	assert.Equal(t, 3, m.annot.input.Height(), "the editor grows to the stored line count")

	result, _ := m.Update(tea.KeyMsg{Type: tea.KeyEnter})
	model := result.(Model)
	anns := model.store.Get("a.go")
	require.Len(t, anns, 1)
	assert.Equal(t, "first line\nsecond line\nthird", anns[0].Comment, "Enter without edits preserves the annotation")
	assert.False(t, model.annot.annotating, "annotation mode cleared")
}

func TestModel_ReAnnotateMultiLineCtrlESeedsFromEditorValue(t *testing.T) {
	lines := []git.DiffLine{
		{NewNum: 1, Content: "added", ChangeType: git.ChangeAdd},
	}
	m := testModel([]string{"a.go"}, map[string][]git.DiffLine{"a.go": lines})
	...
	m.file.lines = lines
	m.nav.diffCursor = 0
	m.store.Add(annot.Annotation{File: "a.go", Line: 1, Type: "+", Comment: "top\nmiddle\nbottom"})
	...
	require.NotNil(t, cmd)
	require.Len(t, fake.CommandCalls(), 1)
	assert.Equal(t, "top\nmiddle\nbottom", fake.CommandCalls()[0].Content, "editor seeds from the full editor value")
...
func TestModel_ReAnnotateMultiLineTypedOverwriteWins(t *testing.T) {
	...
	m.file.lines = lines
	m.nav.diffCursor = 0
	m.store.Add(annot.Annotation{File: "a.go", Line: 1, Type: "+", Comment: "old\nmulti\nline"})
...
func TestModel_ReAnnotateSingleLinePreFillsAsBefore(t *testing.T) {
	...
	m.file.lines = lines
	m.nav.diffCursor = 0
	m.store.Add(annot.Annotation{File: "a.go", Line: 1, Type: "+", Comment: "plain note"})

	m.startAnnotation()
	assert.Equal(t, "plain note", m.annot.input.Value(), "single-line annotation pre-fills the editor")
	assert.Equal(t, 1, m.annot.input.Height(), "a single line needs a single row")
	assert.Contains(t, m.annot.input.Placeholder, "Ctrl+E", "placeholder names the editor key")
}

func TestModel_AnnotationNewlineKeyInsertsLineBreak(t *testing.T) {
	// alt+enter arrives as KeyEnter with the alt modifier, so the keymap must be
	// consulted before the plain Enter case or the annotation would be saved.
	lines := []git.DiffLine{
		{NewNum: 1, Content: "added", ChangeType: git.ChangeAdd},
	}
	m := testModel([]string{"a.go"}, map[string][]git.DiffLine{"a.go": lines})
	...
	m.startAnnotation()
	m.annot.input.SetValue("first")
	m.annot.input.CursorEnd()

	result, _ := m.Update(tea.KeyMsg{Type: tea.KeyEnter, Alt: true})
	model := result.(Model)
	require.True(t, model.annot.annotating, "alt+enter must not save the annotation")
	assert.Equal(t, "first\n", model.annot.input.Value(), "alt+enter inserts a line break")
	assert.Equal(t, 2, model.annot.input.Height(), "the editor grew by one row")
	assert.Empty(t, model.store.Get("a.go"), "nothing stored yet")

	result, _ = model.Update(tea.KeyMsg{Type: tea.KeyRunes, Runes: []rune("second")})
	model = result.(Model)
	result, _ = model.Update(tea.KeyMsg{Type: tea.KeyEnter})
	model = result.(Model)
	anns := model.store.Get("a.go")
	require.Len(t, anns, 1)
	assert.Equal(t, "first\nsecond", anns[0].Comment, "plain Enter saves the multi-line annotation")
}

func TestModel_AnnotationPlaceholderNamesNewlineKey(t *testing.T) {
	lines := []git.DiffLine{{NewNum: 1, Content: "added", ChangeType: git.ChangeAdd}}
	m := testModel([]string{"a.go"}, map[string][]git.DiffLine{"a.go": lines})
	m.tree = testNewFileTree([]string{"a.go"})
	m.file.name = "a.go"
	m.file.lines = lines
	...
	m.startAnnotation()
	assert.Contains(t, m.annot.input.Placeholder, "line break", "placeholder advertises the newline key")
}

func TestModel_ReAnnotateFileLevelMultiLinePreFillsEditor(t *testing.T) {
	m := testModel([]string{"a.go"}, nil)
	m.tree = testNewFileTree([]string{"a.go"})
	m.file.name = "a.go"
	m.file.lines = []git.DiffLine{{NewNum: 1, Content: "x", ChangeType: git.ChangeContext}}
	m.store.Add(annot.Annotation{File: "a.go", Line: 0, Type: "", Comment: "file\nnote\nspans"})

	m.startFileAnnotation()
	assert.Equal(t, "file\nnote\nspans", m.annot.input.Value(), "file-level multi-line pre-fills the editor")
	assert.Equal(t, 3, m.annot.input.Height())
	...
	require.NotNil(t, cmd)
	require.Len(t, fake.CommandCalls(), 1)
	assert.Equal(t, "file\nnote\nspans", fake.CommandCalls()[0].Content, "file-level Ctrl+E seeds from the editor value")
...
func TestModel_EditorFinishedScrollsToShowMultilineAnnotation(t *testing.T) {
	// saving a multi-row annotation via the external-editor path on
	// a line sitting at the bottom of the viewport must sync the scroll,
	// re-rendering alone leaves the appended annotation rows clipped
	// below the viewport.
	lines := []git.DiffLine{
		{NewNum: 1, Content: "line1", ChangeType: git.ChangeContext},
		{NewNum: 2, Content: "line2", ChangeType: git.ChangeContext},
...
func TestModel_AnnotationPlaceholderMentionsEditor(t *testing.T) {
	...
	lines := []git.DiffLine{
		{NewNum: 1, Content: "x", ChangeType: git.ChangeAdd},
	}
	m := testModel([]string{"a.go"}, map[string][]git.DiffLine{"a.go": lines})
	m.tree = testNewFileTree([]string{"a.go"})
	m.layout.focus = paneDiff
...
func TestModel_RemappedEditorKeyOpensEditor(t *testing.T) {
	...
	require.Len(t, fake.CommandCalls(), 1, "extcmd.Command called once")
...
func TestModel_VisualRowToDiffLine_LineAnnotation(t *testing.T) {
	...
	m.store.Add(annot.Annotation{File: "a.go", Line: 2, Type: "+", Comment: "inline note"})
...
func TestModel_VisualRowToDiffLine_WrappedLineAnnotation(t *testing.T) {
	...
	m.store.Add(annot.Annotation{File: "a.go", Line: 2, Type: "+", Comment: longComment})
...
func TestModel_VisualRowToDiffLine_CollapsedHidden(t *testing.T) {
	t.Run("mixed hunk hides all removes", func(t *testing.T) {
		...
		m.file.lines = []git.DiffLine{
			...
			{OldNum: 2, Content: "removed1", ChangeType: git.ChangeRemove},
			{OldNum: 3, Content: "removed2", ChangeType: git.ChangeRemove},
			{NewNum: 2, Content: "added1", ChangeType: git.ChangeAdd},
			{OldNum: 4, NewNum: 3, Content: "ctx2", ChangeType: git.ChangeContext},
		}
		m.modes.collapsed.enabled = true
	...
	t.Run("delete-only hunk keeps placeholder visible", func(t *testing.T) {
		...
		m.file.lines = []git.DiffLine{
			...
			{OldNum: 2, Content: "removed1", ChangeType: git.ChangeRemove},
			{OldNum: 3, Content: "removed2", ChangeType: git.ChangeRemove},
			{OldNum: 4, NewNum: 2, Content: "ctx2", ChangeType: git.ChangeContext},
		}
		m.modes.collapsed.enabled = true
		m.modes.collapsed.expandedHunks = map[int]bool{}
...
func TestModel_VisualRowToDiffLine_RoundTrip(t *testing.T) {
	...
	t.Run("with inline annotation and cursor on annotation sub-row", func(t *testing.T) {
		...
		m.store.Add(annot.Annotation{File: "a.go", Line: 2, Type: "+", Comment: "inline"})
	...
	t.Run("with wrapped file and line annotations", func(t *testing.T) {
		...
		m.store.Add(annot.Annotation{File: "a.go", Line: 0, Type: "", Comment: strings.Repeat("word ", 20)})
		m.store.Add(annot.Annotation{File: "a.go", Line: 2, Type: "+", Comment: strings.Repeat("note ", 20)})
	...
	t.Run("in collapsed mode", func(t *testing.T) {
		...
		m.file.lines = []git.DiffLine{
			{OldNum: 1, NewNum: 1, Content: "ctx", ChangeType: git.ChangeContext},
			{OldNum: 2, Content: "rem1", ChangeType: git.ChangeRemove},
			{OldNum: 3, Content: "rem2", ChangeType: git.ChangeRemove},
...
func TestModel_AnnotationPrefixBody(t *testing.T) {
	...
	t.Run("file-level annotation returns file prefix", func(t *testing.T) {
		m := newModel()
		m.store.Add(annot.Annotation{File: "a.go", Line: 0, Type: "", Comment: "header note"})
		defer m.store.Delete("a.go", 0, "")
	...
	t.Run("line-level annotation returns line prefix", func(t *testing.T) {
		m := newModel()
		m.store.Add(annot.Annotation{File: "a.go", Line: 7, Type: "+", Comment: "added"})
	...
	t.Run("file key with no file annotation returns empty", func(t *testing.T) {
		...
		m.store.Add(annot.Annotation{File: "a.go", Line: 3, Type: " ", Comment: "ctx"})
...
func TestModel_WrappedAnnotationLineCount_MatchesChokepoint(t *testing.T) {
	...
	for _, tc := range tests {
		t.Run(tc.name, func(t *testing.T) {
			m := newModel(tc.width)
			m.store.Add(annot.Annotation{File: "a.go", Line: tc.line, Type: tc.typ, Comment: tc.body})
...
// An empty annotation body still renders: the row painter must emit exactly
// one styled row carrying the prefix, matching the height query.
func TestModel_AnnotationVisualRows_EmptyBodyEmitsPrefixRow(t *testing.T) {
	...
	m.store.Add(annot.Annotation{File: "a.go", Line: 1, Type: " ", Comment: ""})
	count := m.wrappedAnnotationLineCount(m.annotationKey(1, " "))
	assert.Equal(t, 1, count, "height query must match paint (1 row) for empty body")
}

// A file-level annotation with an empty body reserves a viewport row through
// hasFileAnnotation, so renderFileAnnotationHeader must paint one prefix-only
// row to match that height query.
func TestModel_FileAnnotation_EmptyBody_Renders(t *testing.T) {
	...
	m.store.Add(annot.Annotation{File: "a.go", Line: 0, Type: "", Comment: ""})
	defer m.store.Delete("a.go", 0, "")
...
// Golden bytes for the annotation row painter. The expectations were captured
// from the wrap+style loop of renderWrappedAnnotation before cursor
...
func TestModel_AnnotationVisualRows_ByteEquivalentToMaster(t *testing.T) {
	...
	cases := []caseDef{
		...
		{
			// file-level parallel of the empty line-level body: paint must
			// emit one prefix-only row.
...
func TestModel_DeleteAnnotationFromDiffRow(t *testing.T) {
	files := []string{"a.go"}
	lines := []git.DiffLine{
		{NewNum: 1, OldNum: 1, Content: "one", ChangeType: git.ChangeContext},
		{NewNum: 2, Content: "two", ChangeType: git.ChangeAdd},
	}
	m := testModel(files, map[string][]git.DiffLine{"a.go": lines})
	m.tree = testNewFileTree(files)
	m.file.name = "a.go"
	m.file.lines = lines
	m.store.Add(annot.Annotation{File: "a.go", Line: 2, Type: "+", Comment: "the note"})
	m.layout.focus = paneDiff
	m.nav.diffCursor = 1

	require.False(t, m.nav.onAnnotationRow, "cursor sits on the diff row, not the annotation row")
	m.deleteAnnotation()
	assert.Equal(t, 0, m.store.Count(), "the annotation of the cursor line is deleted")
	assert.NotContains(t, m.renderDiff(), "the note")
}

func TestModel_DeleteAnnotationHintsWhenNothingToDelete(t *testing.T) {
	files := []string{"a.go"}
	lines := []git.DiffLine{{NewNum: 1, OldNum: 1, Content: "one", ChangeType: git.ChangeContext}}
	m := testModel(files, map[string][]git.DiffLine{"a.go": lines})
	m.tree = testNewFileTree(files)
	m.file.name = "a.go"
	m.file.lines = lines
	...
	m.deleteAnnotation()
	assert.Equal(t, noAnnotationHint, m.reload.hint)
}
