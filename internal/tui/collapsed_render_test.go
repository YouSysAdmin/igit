...
func TestModel_CollapsedRenderHidesRemovedLines(t *testing.T) {
	...
	m.file.lines = []git.DiffLine{
		...
		{OldNum: 2, Content: "removed line", ChangeType: git.ChangeRemove},
		{NewNum: 2, Content: "added line", ChangeType: git.ChangeAdd},
		{NewNum: 3, Content: "another context", ChangeType: git.ChangeContext},
	}
...
func TestModel_CollapsedRenderModifiedVsPureAdd(t *testing.T) {
	...
	m.file.lines = []git.DiffLine{
		...
		{OldNum: 2, Content: "old", ChangeType: git.ChangeRemove},        // hunk 1: mixed
		{NewNum: 2, Content: "modified line", ChangeType: git.ChangeAdd}, // modified (paired with remove)
		{NewNum: 3, Content: "ctx2", ChangeType: git.ChangeContext},
		{NewNum: 4, Content: "pure add line", ChangeType: git.ChangeAdd}, // hunk 2: pure add
...
func TestModel_CollapsedRenderAnnotationsOnRemovedLinesHidden(t *testing.T) {
	...
	m.store.Add(annot.Annotation{File: "a.go", Line: 2, Type: "-", Comment: "annotation on removed"})
	m.store.Add(annot.Annotation{File: "a.go", Line: 2, Type: "+", Comment: "annotation on added"})
...
func TestModel_CollapsedRenderAllRemovesShowsPlaceholder(t *testing.T) {
	...
	m.file.lines = []git.DiffLine{
		...
		{OldNum: 3, Content: "old3", ChangeType: git.ChangeRemove},
	}
...
func TestModel_CollapsedRenderDeleteOnlyHunkInMixedFile(t *testing.T) {
	...
	m.file.lines = []git.DiffLine{
		...
		{OldNum: 2, Content: "del1", ChangeType: git.ChangeRemove}, // delete-only hunk
		{OldNum: 3, Content: "del2", ChangeType: git.ChangeRemove},
		{NewNum: 2, Content: "ctx2", ChangeType: git.ChangeContext},
		{OldNum: 5, Content: "old", ChangeType: git.ChangeRemove}, // mixed hunk
		{NewNum: 3, Content: "new", ChangeType: git.ChangeAdd},
	}
...
func TestModel_CollapsedRenderMultipleExpandedHunks(t *testing.T) {
	...
	m.file.lines = []git.DiffLine{
		{NewNum: 1, Content: "ctx", ChangeType: git.ChangeContext},
		{OldNum: 2, Content: "old1", ChangeType: git.ChangeRemove}, // hunk at 1
		{NewNum: 2, Content: "new1", ChangeType: git.ChangeAdd},
		{NewNum: 3, Content: "ctx2", ChangeType: git.ChangeContext},
		{OldNum: 4, Content: "old2", ChangeType: git.ChangeRemove}, // hunk at 4
...
func TestModel_CollapsedWrapAddLine(t *testing.T) {
	...
	m.file.lines = []git.DiffLine{
		...
		{NewNum: 2, Content: "this is a very long modified line that should be wrapped at word boundaries for readability", ChangeType: git.ChangeAdd},
		{NewNum: 3, Content: "ctx2", ChangeType: git.ChangeContext},
	}
...
func TestModel_CollapsedWrapPureAddLine(t *testing.T) {
	...
	m.file.lines = []git.DiffLine{
		{NewNum: 1, Content: "ctx", ChangeType: git.ChangeContext},
		{NewNum: 2, Content: "this is a very long pure add line that should be wrapped at word boundaries for readability", ChangeType: git.ChangeAdd},
		{NewNum: 3, Content: "ctx2", ChangeType: git.ChangeContext},
	}
...
func TestModel_CollapsedWrapSearchMatchUsesSearchBg(t *testing.T) {
	...
	t.Run("collapsed add line continuation", func(t *testing.T) {
		...
		m.layout.treeWidth = 0
		m.file.lines = []git.DiffLine{
			{NewNum: 1, Content: "this line is long enough to wrap a couple of times in a narrow pane", ChangeType: git.ChangeAdd},
		}
		m.search.term = "this"
	...
	t.Run("delete placeholder continuation", func(t *testing.T) {
		...
		m.layout.treeWidth = 0
		m.file.lines = []git.DiffLine{
			{OldNum: 1, Content: "del1", ChangeType: git.ChangeRemove},
			{OldNum: 2, Content: "del2", ChangeType: git.ChangeRemove},
			{OldNum: 3, Content: "del3", ChangeType: git.ChangeRemove},
		}
		m.search.term = "this"
		m.search.matches = []int{0}
...
func TestModel_CollapsedWrapNoScrollX(t *testing.T) {
	...
	m.file.lines = []git.DiffLine{
		{NewNum: 1, Content: "ctx", ChangeType: git.ChangeContext},
		{NewNum: 2, Content: "this is a long added line that needs wrapping at boundary", ChangeType: git.ChangeAdd},
	}
...
func TestModel_CollapsedWrapCursorOnFirstLine(t *testing.T) {
	...
	m.file.lines = []git.DiffLine{
		{NewNum: 1, Content: "this is a very long line that will wrap into multiple visual rows when rendered", ChangeType: git.ChangeAdd},
	}
	m.nav.diffCursor = 0
...
func TestModel_CollapsedWrapExpandedHunkUsesStandardWrap(t *testing.T) {
	...
	m.file.lines = []git.DiffLine{
		{NewNum: 1, Content: "ctx", ChangeType: git.ChangeContext},
		{OldNum: 2, Content: "this is a very long removed line that should be wrapped when expanded", ChangeType: git.ChangeRemove},
		{NewNum: 2, Content: "this is a very long added line that should also be wrapped when expanded", ChangeType: git.ChangeAdd},
		{NewNum: 3, Content: "ctx2", ChangeType: git.ChangeContext},
	}
	// expand the hunk
	m.modes.collapsed.expandedHunks = map[int]bool{1: true}
...
func TestModel_CollapsedRenderWithLineNumbers(t *testing.T) {
	...
	m.file.lines = []git.DiffLine{
		...
		{OldNum: 0, NewNum: 2, Content: "added", ChangeType: git.ChangeAdd},
	}
...
func TestModel_CollapsedDeleteOnlyPlaceholderHidesAnnotations(t *testing.T) {
	...
	m.file.lines = []git.DiffLine{
		{NewNum: 1, Content: "ctx1", ChangeType: git.ChangeContext},
		{OldNum: 2, Content: "del1", ChangeType: git.ChangeRemove}, // placeholder line
		{OldNum: 3, Content: "del2", ChangeType: git.ChangeRemove},
		{NewNum: 2, Content: "ctx2", ChangeType: git.ChangeContext},
	}
	m.store.Add(annot.Annotation{File: "a.go", Line: 2, Type: "-", Comment: "note on deleted line"})
...
func TestModel_CollapsedExpandDeleteOnlyHunkWithDot(t *testing.T) {
	...
	m.file.lines = []git.DiffLine{
		{NewNum: 1, Content: "ctx1", ChangeType: git.ChangeContext},
		{OldNum: 2, Content: "del1", ChangeType: git.ChangeRemove}, // delete-only hunk start
		{OldNum: 3, Content: "del2", ChangeType: git.ChangeRemove},
		{NewNum: 2, Content: "ctx2", ChangeType: git.ChangeContext},
	}
...
func TestModel_CursorViewportYCollapsedMode(t *testing.T) {
	...
	t.Run("collapsed with annotation on removed line hidden", func(t *testing.T) {
		...
		m.store.Add(annot.Annotation{File: "a.go", Line: 2, Type: string(git.ChangeRemove), Comment: "old note"})
...
func TestModel_CursorViewportYCollapsedExpandedHunks(t *testing.T) {
	...
	t.Run("mixed expanded and collapsed hunks", func(t *testing.T) {
		lines := []git.DiffLine{
			{NewNum: 1, Content: "ctx1", ChangeType: git.ChangeContext}, // idx 0
			{OldNum: 2, Content: "old1", ChangeType: git.ChangeRemove},  // idx 1 - hunk1 (expanded)
			{NewNum: 2, Content: "new1", ChangeType: git.ChangeAdd},     // idx 2
			{NewNum: 3, Content: "ctx2", ChangeType: git.ChangeContext}, // idx 3
			{OldNum: 4, Content: "old2", ChangeType: git.ChangeRemove},  // idx 4 - hunk2 (collapsed)
			{NewNum: 4, Content: "new2", ChangeType: git.ChangeAdd},     // idx 5
			{NewNum: 5, Content: "ctx3", ChangeType: git.ChangeContext}, // idx 6
		}
		m := testModel(nil, nil)
		m.file.name = "a.go"
		m.file.lines = lines
