...
func TestModel_DotKeyExpandsHunkInCollapsedMode(t *testing.T) {
	lines := []git.DiffLine{
		...
		{OldNum: 2, Content: "old", ChangeType: git.ChangeRemove},   // 1 - hunk start
		{NewNum: 2, Content: "new", ChangeType: git.ChangeAdd},      // 2
		{NewNum: 3, Content: "ctx2", ChangeType: git.ChangeContext}, // 3
		{NewNum: 4, Content: "add2", ChangeType: git.ChangeAdd},     // 4 - hunk 2 start
	}
	m := testModel(nil, nil)
	m.file.lines = lines
	m.file.name = "a.go"
...
func TestModel_DotKeyNoOpInExpandedMode(t *testing.T) {
	lines := []git.DiffLine{
		{NewNum: 1, Content: "add", ChangeType: git.ChangeAdd},
	}
	m := testModel(nil, nil)
	m.file.lines = lines
	m.file.name = "a.go"
...
func TestModel_FileSwitchResetsExpandedHunksPreservesCollapsed(t *testing.T) {
	linesA := []git.DiffLine{
		{NewNum: 1, Content: "a-ctx", ChangeType: git.ChangeContext},
		{NewNum: 2, Content: "a-add", ChangeType: git.ChangeAdd},
	}
	linesB := []git.DiffLine{
		{NewNum: 1, Content: "b-ctx", ChangeType: git.ChangeContext},
	}
	fileDiffs := map[string][]git.DiffLine{"a.go": linesA, "b.go": linesB}
...
func TestModel_BuildModifiedSet(t *testing.T) {
	tests := []struct {
		...
		{name: "pure adds only", lines: []git.DiffLine{
			{NewNum: 1, Content: "ctx", ChangeType: git.ChangeContext},
			{NewNum: 2, Content: "new1", ChangeType: git.ChangeAdd},
			{NewNum: 3, Content: "new2", ChangeType: git.ChangeAdd},
			{NewNum: 4, Content: "ctx", ChangeType: git.ChangeContext},
		}, expect: map[int]bool{}},
		{name: "pure removes only", lines: []git.DiffLine{
			{NewNum: 1, Content: "ctx", ChangeType: git.ChangeContext},
			{OldNum: 2, Content: "old1", ChangeType: git.ChangeRemove},
			{OldNum: 3, Content: "old2", ChangeType: git.ChangeRemove},
			{NewNum: 2, Content: "ctx", ChangeType: git.ChangeContext},
		}, expect: map[int]bool{}},
		{name: "mixed hunk marks adds as modified", lines: []git.DiffLine{
			{NewNum: 1, Content: "ctx", ChangeType: git.ChangeContext},
		...
		{name: "mixed hunk multiple adds", lines: []git.DiffLine{
			{NewNum: 1, Content: "ctx", ChangeType: git.ChangeContext},
			{OldNum: 2, Content: "old1", ChangeType: git.ChangeRemove},
			{OldNum: 3, Content: "old2", ChangeType: git.ChangeRemove},
			{NewNum: 2, Content: "new1", ChangeType: git.ChangeAdd},
			{NewNum: 3, Content: "new2", ChangeType: git.ChangeAdd},
			{NewNum: 4, Content: "new3", ChangeType: git.ChangeAdd},
			{NewNum: 5, Content: "ctx", ChangeType: git.ChangeContext},
		}, expect: map[int]bool{3: true, 4: true, 5: true}},
		{name: "two hunks one mixed one pure add", lines: []git.DiffLine{
			{NewNum: 1, Content: "ctx", ChangeType: git.ChangeContext},
			{OldNum: 2, Content: "old", ChangeType: git.ChangeRemove},  // 1
			{NewNum: 2, Content: "new", ChangeType: git.ChangeAdd},     // 2 - modified
			{NewNum: 3, Content: "ctx", ChangeType: git.ChangeContext}, // 3
			{NewNum: 4, Content: "added", ChangeType: git.ChangeAdd},   // 4 - pure add
			{NewNum: 5, Content: "ctx", ChangeType: git.ChangeContext}, // 5
		}, expect: map[int]bool{2: true}},
		{name: "two hunks both mixed", lines: []git.DiffLine{
			{OldNum: 1, Content: "old1", ChangeType: git.ChangeRemove},  // 0
			{NewNum: 1, Content: "new1", ChangeType: git.ChangeAdd},     // 1 - modified
			{NewNum: 2, Content: "ctx", ChangeType: git.ChangeContext},  // 2
			{OldNum: 3, Content: "old2", ChangeType: git.ChangeRemove},  // 3
			{NewNum: 3, Content: "new2", ChangeType: git.ChangeAdd},     // 4 - modified
			{NewNum: 4, Content: "ctx2", ChangeType: git.ChangeContext}, // 5
		}, expect: map[int]bool{1: true, 4: true}},
		{name: "hunks separated by divider", lines: []git.DiffLine{
			{OldNum: 1, Content: "old", ChangeType: git.ChangeRemove}, // 0 - hunk 1
			{NewNum: 1, Content: "new", ChangeType: git.ChangeAdd},    // 1 - modified
			{Content: "...", ChangeType: git.ChangeDivider},           // 2
			{NewNum: 10, Content: "added", ChangeType: git.ChangeAdd}, // 3 - pure add (hunk 2)
		}, expect: map[int]bool{1: true}},
		{name: "trailing context lines excluded from modified set", lines: []git.DiffLine{
			{OldNum: 1, Content: "old1", ChangeType: git.ChangeRemove},  // 0
			{NewNum: 1, Content: "new1", ChangeType: git.ChangeAdd},     // 1 - modified
			{NewNum: 2, Content: "ctx1", ChangeType: git.ChangeContext}, // 2 - trailing context
			{NewNum: 3, Content: "ctx2", ChangeType: git.ChangeContext}, // 3 - trailing context
			{NewNum: 4, Content: "ctx3", ChangeType: git.ChangeContext}, // 4 - trailing context
			{OldNum: 5, Content: "old2", ChangeType: git.ChangeRemove},  // 5
			{NewNum: 5, Content: "new2", ChangeType: git.ChangeAdd},     // 6 - modified
			{NewNum: 6, Content: "ctx4", ChangeType: git.ChangeContext}, // 7 - trailing context
...
func TestModel_CollapsedDeleteOnlyPlaceholderBlocksAnnotation(t *testing.T) {
	...
	m.file.lines = []git.DiffLine{
		{NewNum: 1, Content: "ctx1", ChangeType: git.ChangeContext},
		{OldNum: 2, Content: "del1", ChangeType: git.ChangeRemove},
		{OldNum: 3, Content: "del2", ChangeType: git.ChangeRemove},
...
func TestModel_IsDeleteOnlyPlaceholder(t *testing.T) {
	...
	m.file.lines = []git.DiffLine{
		{NewNum: 1, Content: "ctx1", ChangeType: git.ChangeContext},
		{OldNum: 2, Content: "del1", ChangeType: git.ChangeRemove}, // idx 1
		{OldNum: 3, Content: "del2", ChangeType: git.ChangeRemove}, // idx 2
		{NewNum: 2, Content: "ctx2", ChangeType: git.ChangeContext},
	}
	hunks := m.findHunks()
...
func TestModel_CollapsedCursorMovementIncludesDeleteOnlyPlaceholder(t *testing.T) {
	...
	m.modes.collapsed.expandedHunks = make(map[int]bool)
	m.file.lines = []git.DiffLine{
		{NewNum: 1, Content: "ctx1", ChangeType: git.ChangeContext}, // 0
		{OldNum: 2, Content: "del1", ChangeType: git.ChangeRemove},  // 1 - placeholder
		{OldNum: 3, Content: "del2", ChangeType: git.ChangeRemove},  // 2 - hidden
		{NewNum: 2, Content: "ctx2", ChangeType: git.ChangeContext}, // 3
	}
	m.nav.diffCursor = 0
...
func TestModel_IsDeleteOnlyHunk(t *testing.T) {
	...
	t.Run("mixed hunk", func(t *testing.T) {
		m.file.lines = []git.DiffLine{
			{NewNum: 1, Content: "ctx", ChangeType: git.ChangeContext},
			{OldNum: 2, Content: "del", ChangeType: git.ChangeRemove},
			{NewNum: 2, Content: "add", ChangeType: git.ChangeAdd},
			{NewNum: 3, Content: "ctx", ChangeType: git.ChangeContext},
		}
		hunks := m.findHunks()
...
func TestModel_HunkStartFor(t *testing.T) {
	...
	m.file.lines = []git.DiffLine{
		...
		{NewNum: 2, Content: "new", ChangeType: git.ChangeAdd},      // 2
		{NewNum: 3, Content: "ctx2", ChangeType: git.ChangeContext}, // 3
		{NewNum: 4, Content: "added", ChangeType: git.ChangeAdd},    // 4
...
func TestModel_CollapsedSkipInitialDividers(t *testing.T) {
	t.Run("skips divider and removed lines", func(t *testing.T) {
		lines := []git.DiffLine{
			...
			{NewNum: 1, Content: "new1", ChangeType: git.ChangeAdd},
			{NewNum: 2, Content: "ctx1", ChangeType: git.ChangeContext},
		}
		m := testModel([]string{"a.go"}, map[string][]git.DiffLine{"a.go": lines})
		m.modes.collapsed.enabled = true
		m.file.lines = lines
...
func TestModel_CollapsedCursorDownMultipleHunks(t *testing.T) {
	lines := []git.DiffLine{
		{NewNum: 1, Content: "ctx1", ChangeType: git.ChangeContext},
		{OldNum: 2, Content: "old1", ChangeType: git.ChangeRemove}, // hunk 1 at idx 1
		{NewNum: 2, Content: "new1", ChangeType: git.ChangeAdd},
		{NewNum: 3, Content: "ctx2", ChangeType: git.ChangeContext},
		{OldNum: 4, Content: "old2", ChangeType: git.ChangeRemove}, // hunk 2 at idx 4
		{OldNum: 5, Content: "old3", ChangeType: git.ChangeRemove},
		{NewNum: 4, Content: "new2", ChangeType: git.ChangeAdd},
		{NewNum: 5, Content: "ctx3", ChangeType: git.ChangeContext},
	}
	m := testModel([]string{"a.go"}, map[string][]git.DiffLine{"a.go": lines})
	m.tree = testNewFileTree([]string{"a.go"})
	m.layout.focus = paneDiff
...
func TestModel_CollapsedPageDownSkipsRemovedLines(t *testing.T) {
	...
	for i := 1; i <= 50; i++ {
		...
		if i%5 == 0 {
			lines = append(lines,
				git.DiffLine{OldNum: i + 100, Content: "old", ChangeType: git.ChangeRemove},
				git.DiffLine{NewNum: i + 1, Content: "new", ChangeType: git.ChangeAdd},
			)
		}
	}
	...
	assert.NotEqual(t, git.ChangeRemove, dl.ChangeType, "cursor should not land on hidden removed line")
}
...
func TestModel_CollapsedCursorToEndSkipsRemovedLines(t *testing.T) {
	lines := []git.DiffLine{
		...
		{OldNum: 2, Content: "old1", ChangeType: git.ChangeRemove},
		{NewNum: 2, Content: "new1", ChangeType: git.ChangeAdd},
		{OldNum: 3, Content: "old2", ChangeType: git.ChangeRemove}, // last lines are removes
		{OldNum: 4, Content: "old3", ChangeType: git.ChangeRemove},
	}
	m := testModel(nil, nil)
	m.file.lines = lines
	m.file.name = "a.go"
...
func TestModel_CollapsedHunkNavigationSkipsRemovedLines(t *testing.T) {
	lines := []git.DiffLine{
		{NewNum: 1, Content: "ctx1", ChangeType: git.ChangeContext}, // 0
		{OldNum: 2, Content: "old1", ChangeType: git.ChangeRemove},  // 1 - hunk 1 start (remove)
		{OldNum: 3, Content: "old2", ChangeType: git.ChangeRemove},  // 2
		{NewNum: 2, Content: "new1", ChangeType: git.ChangeAdd},     // 3 - first visible in hunk 1
		{NewNum: 3, Content: "ctx2", ChangeType: git.ChangeContext}, // 4
		{OldNum: 5, Content: "old3", ChangeType: git.ChangeRemove},  // 5 - hunk 2 start (remove)
		{NewNum: 4, Content: "new2", ChangeType: git.ChangeAdd},     // 6 - first visible in hunk 2
		{NewNum: 5, Content: "ctx3", ChangeType: git.ChangeContext}, // 7
	}
	m := testModel(nil, nil)
	m.file.lines = lines
	m.file.name = "a.go"
...
func TestModel_CollapsedHunkNavigationExpandedHunk(t *testing.T) {
	lines := []git.DiffLine{
		{NewNum: 1, Content: "ctx1", ChangeType: git.ChangeContext}, // 0
		{OldNum: 2, Content: "old1", ChangeType: git.ChangeRemove},  // 1 - hunk 1 start
		{NewNum: 2, Content: "new1", ChangeType: git.ChangeAdd},     // 2
		{NewNum: 3, Content: "ctx2", ChangeType: git.ChangeContext}, // 3
	}
	m := testModel(nil, nil)
	m.file.lines = lines
...
func TestModel_CollapsedHunkNavigationDeleteOnly(t *testing.T) {
	lines := []git.DiffLine{
		{NewNum: 1, Content: "ctx1", ChangeType: git.ChangeContext}, // 0
		{OldNum: 2, Content: "del1", ChangeType: git.ChangeRemove},  // 1 - hunk 1 (delete-only)
		{OldNum: 3, Content: "del2", ChangeType: git.ChangeRemove},  // 2
		{NewNum: 2, Content: "ctx2", ChangeType: git.ChangeContext}, // 3
		{OldNum: 5, Content: "old3", ChangeType: git.ChangeRemove},  // 4 - hunk 2 (mixed)
		{NewNum: 3, Content: "new3", ChangeType: git.ChangeAdd},     // 5
		{NewNum: 4, Content: "ctx3", ChangeType: git.ChangeContext}, // 6
	}
	m := testModel(nil, nil)
	m.file.lines = lines
	m.file.name = "a.go"
...
func TestModel_FirstVisibleInHunk_AllRemoves(t *testing.T) {
	lines := []git.DiffLine{
		{NewNum: 1, Content: "ctx", ChangeType: git.ChangeContext},
		{OldNum: 2, Content: "old1", ChangeType: git.ChangeRemove},  // idx 1
		{OldNum: 3, Content: "old2", ChangeType: git.ChangeRemove},  // idx 2
		{NewNum: 2, Content: "ctx2", ChangeType: git.ChangeContext}, // idx 3
	}
	m := testModel(nil, nil)
	m.file.lines = lines
	m.modes.collapsed.enabled = true
...
func TestModel_AdjustCursorIfHidden(t *testing.T) {
	lines := []git.DiffLine{
		...
		{OldNum: 3, Content: "old2", ChangeType: git.ChangeRemove},  // idx 2 - hidden
		{NewNum: 2, Content: "new1", ChangeType: git.ChangeAdd},     // idx 3
		{NewNum: 3, Content: "ctx2", ChangeType: git.ChangeContext}, // idx 4
	}
	...
	t.Run("cursor on hidden line moves backward to placeholder", func(t *testing.T) {
		onlyRemoves := []git.DiffLine{
			{NewNum: 1, Content: "ctx1", ChangeType: git.ChangeContext}, // idx 0
			{OldNum: 2, Content: "old1", ChangeType: git.ChangeRemove},  // idx 1 - placeholder (visible)
			{OldNum: 3, Content: "old2", ChangeType: git.ChangeRemove},  // idx 2 - hidden
		}
		m := testModel(nil, nil)
	...
	t.Run("cursor on delete-only hunk placeholder stays put", func(t *testing.T) {
		...
		deleteOnly := []git.DiffLine{
			{Content: "...", ChangeType: git.ChangeDivider},            // idx 0 - divider
			{OldNum: 1, Content: "old1", ChangeType: git.ChangeRemove}, // idx 1 - placeholder (visible)
			{OldNum: 2, Content: "old2", ChangeType: git.ChangeRemove}, // idx 2 - hidden
			{OldNum: 3, Content: "old3", ChangeType: git.ChangeRemove}, // idx 3 - hidden
		}
		m := testModel(nil, nil)
	...
	t.Run("single hunk all removes placeholder at start", func(t *testing.T) {
		...
		allRemoves := []git.DiffLine{
			{OldNum: 1, Content: "old1", ChangeType: git.ChangeRemove}, // idx 0 - placeholder (visible)
			{OldNum: 2, Content: "old2", ChangeType: git.ChangeRemove}, // idx 1 - hidden
			{OldNum: 3, Content: "old3", ChangeType: git.ChangeRemove}, // idx 2 - hidden
		}
		m := testModel(nil, nil)
...
func TestModel_ToggleHunkExpansionAdjustsCursor(t *testing.T) {
	lines := []git.DiffLine{
		{NewNum: 1, Content: "ctx1", ChangeType: git.ChangeContext},
		{OldNum: 2, Content: "old1", ChangeType: git.ChangeRemove}, // idx 1
		{NewNum: 2, Content: "new1", ChangeType: git.ChangeAdd},    // idx 2
		{NewNum: 3, Content: "ctx2", ChangeType: git.ChangeContext},
	}
	m := testModel([]string{"a.go"}, map[string][]git.DiffLine{"a.go": lines})
	m.tree = testNewFileTree([]string{"a.go"})
...
func TestModel_CollapsedCursorDownSkipsPlaceholderAnnotation(t *testing.T) {
	...
	m.store.Add(annot.Annotation{File: "a.go", Line: 2, Type: "-", Comment: "hidden note"})
	m.nav.diffCursor = 0
	m.layout.focus = paneDiff
	...
	assert.False(t, m.nav.onAnnotationRow, "should not stop on invisible annotation of placeholder")

	// move down again goes to ctx2 (idx 3), skipping the annotation
	m.moveDiffCursorDown()
	assert.Equal(t, 3, m.nav.diffCursor)
	assert.False(t, m.nav.onAnnotationRow)
}
...
func TestModel_CollapsedCursorUpSkipsPlaceholderAnnotation(t *testing.T) {
	...
	m.moveDiffCursorUp()
	assert.Equal(t, 1, m.nav.diffCursor)
	assert.False(t, m.nav.onAnnotationRow, "should not land on invisible annotation of placeholder")
}

func TestModel_CollapsedToggleClearsAnnotationState(t *testing.T) {
	// toggling collapsed mode should clear onAnnotationRow
	m := testModel(nil, nil)
	m.layout.focus = paneDiff
	m.file.name = "a.go"
	m.file.lines = []git.DiffLine{
	...
	m.store.Add(annot.Annotation{File: "a.go", Line: 2, Type: "-", Comment: "some note"})
	m.nav.diffCursor = 1
	m.nav.onAnnotationRow = true // simulating cursor on annotation in expanded mode

	m.toggleCollapsedMode()
	assert.True(t, m.modes.collapsed.enabled)
	assert.False(t, m.nav.onAnnotationRow, "onAnnotationRow should be cleared when toggling mode")
}

func TestModel_CollapsedHunkCollapseClearsAnnotationState(t *testing.T) {
	// collapsing a hunk should clear onAnnotationRow for annotations on removed lines
	m := testModel(nil, nil)
	m.layout.focus = paneDiff
	m.file.name = "a.go"
	m.file.lines = []git.DiffLine{
	...
	m.modes.collapsed.expandedHunks = map[int]bool{1: true}
	m.nav.diffCursor = 1
	m.nav.onAnnotationRow = true // on annotation of expanded remove line

	m.toggleHunkExpansion()
	assert.False(t, m.nav.onAnnotationRow, "onAnnotationRow should be cleared when hunk collapses")
}
...
func TestModel_CollapsedDeleteAnnotationBlockedOnPlaceholder(t *testing.T) {
	...
	m.store.Add(annot.Annotation{File: "a.go", Line: 2, Type: "-", Comment: "keep this"})
	m.nav.diffCursor = 1
	m.layout.focus = paneDiff
	...
	// attempt delete - the placeholder hides the annotation, so nothing is removed
	m.deleteAnnotation()
