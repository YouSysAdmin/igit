...
// SyntaxHighlighterMock is a mock implementation of tui.SyntaxHighlighter.
//
//	func TestSomethingThatUsesSyntaxHighlighter(t *testing.T) {
//
//		// make and configure a mocked tui.SyntaxHighlighter
//		mockedSyntaxHighlighter := &SyntaxHighlighterMock{
//			HighlightLinesFunc: func(filename string, lines []git.DiffLine) []string {
...
//		}
//
//		// use mockedSyntaxHighlighter in code that requires tui.SyntaxHighlighter
...
func (mock *SyntaxHighlighterMock) HighlightLines(filename string, lines []git.DiffLine) []string {
