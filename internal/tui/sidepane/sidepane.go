...
// MarkRenderer draws the per-file status, reviewed, annotation and stage
// marks. Satisfied by *style.Renderer through the UI's styleRenderer interface.
type MarkRenderer interface {
...
type FileTreeRender struct {
	...
	StageMarked  map[string]bool // files carrying review stage marks
	Resolver     Resolver
...
// shared by FileTree.EnsureVisible and List.EnsureVisible.
