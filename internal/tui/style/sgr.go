...
type sgrState struct {
	fg, bg       string // complete color sequences from ESC[ to m, truecolor or indexed
	bold, italic bool
	reverse      bool
}

// scan walks the string looking for SGR sequences and returns the updated state.
// tracks foreground color (38 truecolor or 3x indexed), background color (48 truecolor or 4x indexed),
